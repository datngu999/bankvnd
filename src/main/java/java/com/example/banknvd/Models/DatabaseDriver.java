...
public class DatabaseDriver {
    ...
    public DatabaseDriver() {
        try {
            ...
            String url = "jdbc:mysql://127.0.0.1:3306/NVD_BANK"; // thay bằng DB thật của bạn
            String user = "root"; // thay bằng user thật
            String password = "dat060406"; // thay bằng pass thật
...
//            System.out.println(resultSet.getString("dateCreated"));
    ...
    public int getLastClientId() {
        ...
        ResultSet rs = null;
        try {
            String sql = "SELECT MAX(ID) AS max_id FROM Clients";
            PreparedStatement ps = this.conn.prepareStatement(sql);
            rs = ps.executeQuery();
            if (rs.next()) {
                id = rs.getInt("max_id");
